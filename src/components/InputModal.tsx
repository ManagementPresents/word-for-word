        ...
        <div className="h-full flex flex-col items-center justify-center max-w-[390px] mx-auto pt-9 text-primary dark:text-primary-dark">
          <div className="flex-1 w-full sm:text-base text-sm">
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <button className={`green-style hover:yellow-style font-bold py-2 px-4 rounded ${!isValidWordle ? 'rounded opacity-50 cursor-not-allowed' : ''}`} onClick={() => { handleWordleSubmission() }}>
                Submit Wordle
              </button>
